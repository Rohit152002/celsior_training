...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAPIWithDatabase.Models.CartItem", b =>
                {
                    b.Property<int>("SNo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAPIWithDatabase.Models.OrderDetail", b =>
                {
                    b.Property<int>("SNo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAPIWithDatabase.Models.Cart", b =>
                {
                    b.HasOne("WebAPIWithDatabase.Models.Customer", "Customer")
                        .WithOne("Cart")
                        .HasForeignKey("WebAPIWithDatabase.Models.Cart", "CustomerId")
            ...
            modelBuilder.Entity("WebAPIWithDatabase.Models.CartItem", b =>
                {
                    b.HasOne("WebAPIWithDatabase.Models.Cart", "Cart")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("WebAPIWithDatabase.Models.OrderDetail", b =>
                {
                    b.HasOne("WebAPIWithDatabase.Models.Order", "Order")
            ...
            modelBuilder.Entity("WebAPIWithDatabase.Models.User", b =>
                {
                    b.HasOne("WebAPIWithDatabase.Models.Customer", "Customer")
                        .WithOne("User")
                        .HasForeignKey("WebAPIWithDatabase.Models.User", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
