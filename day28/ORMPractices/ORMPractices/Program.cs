    ...
    internal class Program
    {
        ...
        void PrintProductDetails()
        {
            ...
            foreach (var product in products)
            {
                ...
                var suppliers = context.SupplierProduct.Where(sp=>sp.ProductId == product.Id).ToList();
                foreach(var supplierProduct in suppliers)
                {
                    var supplier = context.Supplier.FirstOrDefault(s => s.SupplierId == supplierProduct.SupplierId);
